      ...
      <section className="mt-4 rounded-2xl border border-white/10 bg-[#101b37] p-4 md:p-5">
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-3">
          <div className="rounded-xl border border-white/10 bg-white/[0.03] p-3">
            ...
            <div className="mt-2 text-sm font-semibold text-slate-100">Length must be 10-20 minutes</div>
            <p className="mt-1 text-xs text-slate-400">Training dataset shorter or longer than this range is not accepted.</p>
          </div>
